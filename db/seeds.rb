...
Product.create!(title: 'CoffeeScript: Accelerated JavaScript Development',
	description:
		%{<p>CoffeeScript is JavaScript done right. It provides all of JavaScript’s functionality wrapped in a cleaner, more succinct syntax. 
...
Product.create!(title: 'Rails Test Prescriptions: Keeping Your Application Healthy',
	description:
		%{<p>Rails Test Prescriptions is a comprehensive guide to testing Rails applications, covering Test-Driven Development from both a theoretical perspective (why to test) and from a practical perspective (how to test effectively). 
			It covers the core Rails testing tools and procedures for Rails 2 and Rails 3, and introduces popular add-ons, including RSpec, Shoulda, Cucumber, Factory Girl, and Rcov.
		 </p>},
		image_url: 'test.jpg',
		price: 27.50)
...
Product.create!(title: 'Crafting Rails 4 Applications: Expert Practices for Everyday Rails Development',
	description:
		%{<p>Get ready to see Rails as you’ve never seen it before. 
			Learn how to extend the framework, change its behavior, and replace whole components to bend it to your will. 
